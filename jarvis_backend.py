...
# uvicorn jarvis_backend:app --host 0.0.0.0 --port 8000 --reload
def processCommand(c):
    if "open google" in c.lower():
        ...
        speak("Brightness adjustment is not supported directly via script but can be done manually.")
    elif "news" in c:
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            print(f"Received command: {data}")  # Log received command
